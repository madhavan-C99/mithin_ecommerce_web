...
//   // const mapSrc = mapAddress
//   // ? `https://www.google.com/maps/embed/v1/place?key=${import.meta.env.VITE_GOOGLE_MAPS_API_KEY}&q=${encodeURIComponent(mapAddress)}&zoom=16`
//   // : "";
...
//           },${parseFloat(lat) - 0.005},${parseFloat(lon) + 0.005},${
...
const OrderAcceptDialog = ({
  ...
  // ── Google Maps open-in-browser link ──────────────────────────────────────
  const mapOpenLink = mapAddress
      ...
      >
        ...
        {orderData && !loading && (
          <Box display="flex" flexDirection="column" gap={2}>
            ...
            {/* ──────────────────────────────────────
                2. Customer Location (Google Maps embed)
            ────────────────────────────────────── */}
            <SectionCard noPadding>
              <Box
                sx={{
                    ...
                    return (
                      <Box key={step}>
                        <Box display="flex" alignItems="center" gap={1.5}>
                          ...
                          >
                            <Typography fontSize={11} fontWeight={700} color="#fff">
                              {index + 1}
                            </Typography>
                          </Box>
                          <Typography
                  ...
                  <TableBody>
                    {orderData.product?.map((item, idx) => (
                      <TableRow
                        ...
                        sx={{ "&:hover": { bgcolor: "#f9fafb" } }}
                      >
                        <TableCell sx={{ fontSize: { xs: 11, sm: 12 }, color: "#84868a" }}>
                          {idx + 1}
                        </TableCell>
                        <TableCell
                          sx={{
...
/>
              ...
              {!selectedDeliveryBoy && (
                <Typography
                  ...
                  fontWeight={500}
                >
                  ⚠&nbsp;Please select a delivery boy to enable the Accept button
                </Typography>
              )}
            </SectionCard>
      ...
      >
        ...
        <Button
          ...
          variant="contained"
          startIcon={
            confirming ? <CircularProgress size={14} color="inherit" /> : null
          }
          sx={{
            borderRadius:  "10px",
            px:            { xs: 3, sm: 4 },
