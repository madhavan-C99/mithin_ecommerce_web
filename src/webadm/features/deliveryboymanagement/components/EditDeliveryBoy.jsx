// src/webadm/features/deliveryboy/components/EditDeliveryBoy.jsx
...
// ─── Component ────────────────────────────────────────────────────────────────
export default function EditDeliveryBoy({ open, onClose, onSuccess, deliveryBoy }) {
  ...
  useEffect(() => {
    if (deliveryBoy) {
      setForm({
        ...
        mobile:        deliveryBoy.mobile_number || "",
        address_line1: deliveryBoy.address_line1 || "",
        address_line2: deliveryBoy.address_line2 || "",
      });
      setErrors({});
    }
  }, [deliveryBoy]);
  ...
  const handleSubmit = async () => {
    ...
    setLoading(true);
    try {
      await deliveryBoyAPI.updateDeliveryBoy(form);
      ...
      <DialogTitle sx={{ p: 0, flexShrink: 0 }}  mb={1}>
        ...
        >
          <Box sx={{ display: "flex", alignItems: "center", gap: 1.75 }}>
            ...
            >
              <EditIcon sx={{ color: "#fff", fontSize: { xs: 17, sm: 19 } }} />
            </Box>
            <Box>
              <Typography
                sx={{
              ...
              >
                Update the delivery boy's information
              </Typography>
            </Box>
          </Box>
