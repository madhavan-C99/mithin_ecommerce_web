...
// Top-ல் import சேர்க்கவும்
import DeliveryMap from "./DeliveryMap"; // path உங்கள் folder-க்கு தகுந்த மாதிரி மாத்துங்க
...
const ActiveOrderCard = ({ order, onAccept, onReportSuccess }) => {
  ...
  const handleReached = () => navigate(`/${deliveryPath}/otp`, { state: { order_id } });
  ...
  return (
    <>
      ...
      >
        ...
        <Box sx={{ height: { xs: 200, sm: 240, md: 280 } }}>
          <DeliveryMap destinationAddress={cleanAddress} />
        </Box>
